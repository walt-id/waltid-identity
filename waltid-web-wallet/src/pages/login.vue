<template>
  <div class="flex min-h-full">
      ...
      <div
        ...
        <div class="">
          ...
          <p v-if="!isOidcLogin" class="mt-2 text-sm text-gray-600">
            Or {{ " " }}
            <NuxtLink class="font-medium text-blue-600 hover:text-blue-500" to="/signup">sign up for your SSI wallet
            </NuxtLink>
            !
          </p>
            ...
            <form class="space-y-6" @submit.prevent="login">
              ...
              <div class="flex items-center justify-between pb-2">
                <div class="flex items-center">
                  <input id="remember-me" class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600"
    ...
    <div class="overflow-hidden max-h-screen absolute left-0 w-full h-full -z-10 hidden lg:block">
      <img ref="container" :class="[isLoggingIn ? 'zoom-in' : 'zoom-out']" :src="bgImg" alt=""
    ...
    <div v-if="showWaltidLoadingSpinner" :class="[isLoggingIn ? 'animate-spin' : '']" :style="cardStyle"
              ...
              <DialogPanel
                ...
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900"> Invalid login
                    </DialogTitle>
                    <div class="mt-2">
