        ...
        <div class="mt-6 border p-4 rounded-2xl">
            <div>
                ...
                <div
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-4">
                        ...
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <SwitchGroup as="div" class="flex items-center">
                                <Switch v-model="enableLoadPrivateKey" :class="[
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-4">
                        <label class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5" for="format">Format
                        </label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            ...
                            <p class="mt-3 text-sm leading-6 text-gray-600">
                                Depending on the program you want to import your key in, you can choose different formats to
                                export your key(/pair) with.
                            </p>
                        </div>
                    </div>
                </div>
