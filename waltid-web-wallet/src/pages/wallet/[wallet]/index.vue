<template>
    <div>
        ...
        <CenterMain>
            <div>
                <span v-if="credentials && credentials.length > 0" class="font-semibold">Your credentials ({{
                ...
                <div v-else class="text-center pt-3">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started filling your wallet by receiving some credentials!
                    </p>
                    <div class="mt-4">
                        <NuxtLink
                            ...
                            :to="`/wallet/${currentWallet}/settings/issuers`" type="button">
