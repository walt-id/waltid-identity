...
//        )
    ...
    """.trimIndent()
        ...
        val identityCredential = """
        {
          ...
          "authenticationMethod": "PRE_AUTHORIZED",
          "x5Chain": [
            "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
          ],
          "trustedRootCAs": [
