...
object Issuer2CredentialScenarios {
    ...
    val configured: List<Issuer2CredentialScenario> = listOf(
        ...
        jwtVcJson("portableDocumentA1", "PortableDocumentA1_jwt_vc_json"),
        ...
        jwtVcJson("legalRegistrationNumber", "LegalRegistrationNumber_jwt_vc_json"),
        ...
        jwtVcJson("proofOfAddressCredential", "ProofOfAddressCredential_jwt_vc_json"),
        jwtVcJson("ePassportCredential", "ePassportCredential_jwt_vc_json"),
