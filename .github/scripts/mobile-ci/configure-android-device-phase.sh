...
case "$phase" in
  ...
  dc-api-compose)
    ...
    script="ANDROID_TEST_CLASS=$dc_api_test_classes EXPECTED_ANDROID_TEST_CASE_COUNT=12 ./waltid-identity/.github/scripts/mobile-ci/run-android-dc-api-compose-tests.sh"
