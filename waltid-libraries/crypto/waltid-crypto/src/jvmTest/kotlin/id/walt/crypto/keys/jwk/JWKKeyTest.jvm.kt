...
class JWKKeyTest {
    ...
    inner class Ed25519KeyType {
        ...
        inner class JWKFormat {
            ...
            @Test
            fun `should NOT be able to import JWK generated by itself`() = runTest {
        ...
        inner class PEMFormat {
            ...
            @Test
            fun `should NOT be able to export private key`() = runTest {
            ...
            @Test
            fun `should NOT be able to export public key`() = runTest {
                assertThrows<NotImplementedError> {
            ...
            @Test
            fun `should NOT be able to import private key`() = runTest {
                val pemString = """
                -----BEGIN PRIVATE KEY-----
                ...
                assertThrows<NotImplementedError> {
                    JWKKey.importPEM(pemString)
                }
            }

            @Test
            fun `should NOT be able to import public key`() = runTest {
                val pemString = """
                -----BEGIN PUBLIC KEY-----
            ...
            @Test
            fun `should NOT be able to import PEM generated by itself`() = runTest {
