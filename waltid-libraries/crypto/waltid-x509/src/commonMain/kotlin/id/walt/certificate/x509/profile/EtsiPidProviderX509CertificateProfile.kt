...
/**
 * Profile for PID Provider end-entity certificates - certificates whose corresponding private
 ...
 */
object EtsiPidProviderX509CertificateProfile : X509CertificateProfile, X509CertificateValidator {
     ...
     */
    fun X509CertificateDataBuilder.profilePidProviderCertificate(
        subjectKey: Key? = null,
        subjectDn: String,
        ...
        applyProviderCertificate(
            ...
            subjectDn = subjectDn,
            qcTypeOid = Etsi119412Part6.ID_ETSI_QCT_PID,
    ...
    override suspend fun validate(
        ...
        validateProviderCertificate(context, x509Certificate, Etsi119412Part6.ID_ETSI_QCT_PID)
    }
}
