...
public interface IdentityKeyCustodian {
    ...
    public suspend fun importKey(identity: SigningIdentity, privateKey: EncodedKey.Jwk): IdentityCustodyReceipt
}
...
public class SigningIdentityCustodyOption internal constructor(
...
public sealed interface SigningIdentityCustodyResult {
    /** The destination reported the original public key after import.
     * @property reference Stable destination key reference. */
    public data class Imported(public val reference: IdentityCustodyReference) : SigningIdentityCustodyResult
    ...
    public data class Failed(public val reason: SigningIdentityFailure) : SigningIdentityCustodyResult
}
