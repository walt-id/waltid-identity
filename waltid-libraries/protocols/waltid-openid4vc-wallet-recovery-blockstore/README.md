...
Register `BlockStoreIdentityRecovery(context, namespace)` in `IdentityConfiguration.recoveryProviders`. The default mode requires OS end-to-end encryption availability before cloud submission; `DeviceTransfer` disables cloud backup.
