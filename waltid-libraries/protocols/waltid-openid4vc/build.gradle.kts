...
kotlin {
    ...
    sourceSets {
        ...
        jvmTest.dependencies {
            implementation(identityLibs.nimbus.jose.jwt)
            implementation("io.kotest:kotest-runner-junit5:6.2.0") // should be replaced
            implementation("io.kotest:kotest-assertions-core:6.2.0") // should be replaced
            implementation("io.kotest:kotest-assertions-json:6.2.0") // should be replaced
