package id.walt.policies2.status.validator

import id.walt.policies2.policies.status.CredentialFetcher
import id.walt.policies2.policies.status.Values.BITSTRING_STATUS_LIST
import id.walt.policies2.policies.status.Values.BITSTRING_STATUS_LIST_ENTRY
import id.walt.policies2.policies.status.Values.REVOCATION_LIST_2020
import id.walt.policies2.policies.status.Values.REVOCATION_LIST_2020_ENTRY
import id.walt.policies2.policies.status.Values.STATUS_LIST_2021
import id.walt.policies2.policies.status.Values.STATUS_LIST_2021_ENTRY
import id.walt.policies2.policies.status.Values.TOKEN_STATUS_LIST
import id.walt.policies2.policies.status.bit.BitRepresentationStrategy
import id.walt.policies2.policies.status.bit.BitValueReader
import id.walt.policies2.policies.status.bit.BitValueReaderFactory
import id.walt.policies2.policies.status.expansion.*
import id.walt.policies2.policies.status.model.*
import id.walt.policies2.policies.status.reader.StatusValueReader
import id.walt.policies2.policies.status.validator.StatusValidator
import io.mockk.*
