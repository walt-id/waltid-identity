...
object W3CExamples {
    ...
    val ossIssuedW3CSdJwt2Values = mapOf(
        ...
        w3cCredential to w3cCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.UNSIGNED
        ), // unsigned
        dipEcdsaSignedW3CCredential to dipEcdsaSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.DATA_INTEGRITY_PROOF
        ), // DataIntegrityProof: ECDSA
        dipEddsaSignedW3CCredential to dipEddsaSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.DATA_INTEGRITY_PROOF
        ), // DataIntegrityProof: EdDSA
        dipEcdsaSdSignedW3CCredential to dipEcdsaSdSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.DATA_INTEGRITY_PROOF
        ), // DataIntegrityProof: ECDSA-SD
        dipBbsSignedW3CCredential to dipBbsSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.DATA_INTEGRITY_PROOF
        ), // DataIntegrityProof: BBS
        joseSignedW3CCredential to joseSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.JWT
        ), // JOSE
        waltidIssuedJoseSignedW3CCredential to waltidIssuedJoseSignedW3CCredentialValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_1_1,
            CredentialDetectorTypes.SignaturePrimaryType.JWT
        ),
        ...
        ossIssuedW3CSdJwt to ossIssuedW3CSdJwtValues to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_1_1,
            CredentialDetectorTypes.SignaturePrimaryType.SDJWT,
            containsDisclosables = true,
        ...
        ossIssuedW3CSdJwt2 to ossIssuedW3CSdJwt2Values to CredentialDetectionResult(
            CredentialPrimaryDataType.W3C,
            W3CSubType.W3C_2,
            CredentialDetectorTypes.SignaturePrimaryType.SDJWT,
            containsDisclosables = true,
