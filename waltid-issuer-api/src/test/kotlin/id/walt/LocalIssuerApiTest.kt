...
class IssuerApiTest {
  ...
  """
    ...
    fun testJwt() = runTest {
        ...
        val issueRequest = IssuanceRequest(jsonKeyObj, TEST_ISSUER_DID, "OpenBadgeCredential", w3cVc, null, jsonMappingObj)
    ...
    fun testSdJwt() = runTest {
        ...
        val issueRequest = IssuanceRequest(jsonKeyObj, TEST_ISSUER_DID, "OpenBadgeCredential", w3cVc, null, jsonMappingObj, selectiveDisclosureMap)
