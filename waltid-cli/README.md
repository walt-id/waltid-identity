...
| `waltid vc sign --key=./myEd25519Key.json --subject=did:web:z6Mkjm2gaGsodGchfG4k8P6KwCHZsVEPZho5VuEbY94qiBB9 --issuer=did:web:example.com ./myCredential.json` | Signs a W3C Verifiable Credential. The VC needs [to be created first](#1-create-a-vc).                                                                                                                               |
| `waltid vc sign --key=./myEd25519Key.json --subject=did:key:z6Mkjm2gaGsodGchfG4k8P6KwCHZsVEPZho5VuEbY94qiBB9 ./myCredential.json`                              | Signs a W3C Verifiable Credential with a generated Issuer DID (did:key).                                                                                                                                             |
