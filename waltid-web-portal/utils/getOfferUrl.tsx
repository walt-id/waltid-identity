...
const getOfferUrl = async (credentials: Array<AvailableCredential>, NEXT_PUBLIC_VC_REPO: string, NEXT_PUBLIC_ISSUER: string) => {
  const payload = await Promise.all(credentials.map(async (c) => {
    ...
    let payload: {
      'issuerDid': string,
      'issuanceKey': { "type": "jwk", "jwk": string },
      vc: any,
      mapping?: any,
      ...
      'issuanceKey': { "type": "jwk", "jwk": "{\"kty\":\"OKP\",\"d\":\"HIN9WcVCqhGvwZ8I47WeMtxGceSKpvaEnu5eXAoWyDo\",\"crv\":\"Ed25519\",\"kid\":\"CFQ-Nra5ynyBsfxwy7aNf8duAEUCMlMIrRIrDg6DIy4\",\"x\":\"h5nbw6X9JmI0BvuQ5M0JXfzO8s2eEbPdV29wsHTL9pk\"}" },
      vc: offer
    }
