...
public enum WalletAccessibilityID {
    ...
    public static let settingsAction = identifier("settingsAction")
    public static let settingsScreen = identifier("settingsScreen")
    public static let walletDID = identifier("did")
    public static let walletKeyID = identifier("keyId")
    public static let resetWallet = identifier("resetAction")
    public static let resetWalletConfirm = identifier("resetConfirm")
