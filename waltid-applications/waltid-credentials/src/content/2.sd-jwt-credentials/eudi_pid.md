# EUDI PID - Person Identification Data (urn:eudi:pid:1)

This is an EU Digital Identity Wallet Person Identification Data (PID) credential in DC+SD-JWT format.
...
```json
{
  ...
  "expiry_date": "2034-01-15T10:30:00Z",
...
The EUDI PID contains the following mandatory and optional claims:
...
This credential follows the EU Digital Identity Wallet Architecture and Reference Framework (ARF) for person identification data.
