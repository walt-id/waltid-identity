...
actor EudiTestBackend {
    ...
    /// PID Issuer CA 02, pinned by the EUDI reference verifier test flows.
    ///
    /// Keep this test fixture aligned with
    /// `EudiTestBackend.verifierTrustAnchorPem` in waltid-mobile-test-utils.
    nonisolated static let verifierTrustAnchorPEM = """
        -----BEGIN CERTIFICATE-----
