                            ...
                            <nav aria-label="Sidebar" class="mt-5 h-full flex-shrink-0 divide-y divide-blue-800 overflow-y-auto">
                                <div class="space-y-1 px-2">
                                    <div v-for="navItem in navigation">
                                        ...
                                        >
                                            <component :is="item.icon" aria-hidden="true" class="mr-4 h-6 w-6 flex-shrink-0 text-blue-200" />
                                            {{ item.name }}
                                        </NuxtLink>
                                    </div>
                                </div>
                                <div class="mt-6 pt-6">
                                    ...
                                    <div class="absolute left-0 right-0 flex flex-col items-center justify-center bottom-3">
                                        <NuxtLink :to="demoWalletUrl" class="text-white group text-base font-medium"> Switch To Demo Version </NuxtLink>
                ...
                <NuxtErrorBoundary @error="logError">
                    ...
                    <template #error="{ error }">
                        <CenterMain>
                            ...
                            <pre v-if="error.value?.response?._data">{{ error.value?.response?._data}}</pre>
