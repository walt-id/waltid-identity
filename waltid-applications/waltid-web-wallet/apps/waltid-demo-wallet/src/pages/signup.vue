<template>
  <div class="min-h-full sm:bg-[url('/images/pcg-bg.webp')] bg-cover bg-center bg-no-repeat">
    <!-- Mobile View -->
    <div class="flex flex-col sm:hidden">
      ...
      <div
        ...
        <div class="mx-auto w-full max-w-sm lg:w-96 p-3 lg:backdrop-blur-md lg:rounded-3xl lg:bg-opacity-40">
          <h2 class="mt-4 text-3xl font-bold tracking-tight text-black text-center">
            Sign Up
          </h2>
    ...
    <!-- Desktop View -->
    <div class="hidden sm:flex h-full backdrop-brightness-80">
                ...
                <div class="space-y-1">
                  <div>
                    <div class="flex justify-between items-center">
                      <label class="block text-sm font-medium leading-6 text-[#3E4C59]" for="password">
