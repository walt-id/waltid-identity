    ...
    <div>
        <PageHeader>
            <template v-slot:title>
                <div class="ml-3">
                    <h1 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:leading-9">Receive entra
                        credentials</h1>
                    <p>
                        ...
                        <div v-for="group in groupedCredentialTypes.keys()" :key="group.id" class="relative">
                            ...
                            <ul class="divide-y divide-gray-100" role="list">
                                <li v-for="credential in groupedCredentialTypes.get(group)" :key="credential"
                                    ...
                                    <CredentialIcon :credentialType="credential.name.value"
                                        class="h-6 w-6 flex-none rounded-full bg-gray-50"></CredentialIcon>

                                    <div class="flex min-w-0 flex-row items-center">
                                        <span class="text-lg font-semibold leading-6 text-gray-900">{{ credential.id
                                            }}.</span>
