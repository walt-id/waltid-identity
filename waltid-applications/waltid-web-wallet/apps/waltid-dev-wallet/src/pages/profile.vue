<template>
    <CenterMain>
        ...
        <span v-else-if="wallets && wallets.length > 0" class="font-semibold">Your connected addresses ({{
            wallets.length }}):</span>
            ...
            <li v-for="wallet in wallets" :key="wallet.id" class="flex items-center justify-between gap-x-6 py-4">
                <div class="flex w-full">
                    ...
                    <div class="flex flex-row space-x-1 items-center">
                        <!-- connect -->
                        <button :class="{ 'bg-red-500 hover:bg-red-600': wallet.owner }"
                        ...
                        <!-- unlink -->
                        <button :class="{ 'opacity-25': wallet.owner }" :disabled="wallet.owner"
                            ...
                            type="button" @click="unlinkWallet(wallet.id)">
                            <span>Unlink</span>
                        </button>
                    </div>
                </div>
