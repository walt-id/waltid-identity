<template>
    <div class="flex min-h-full">
        ...
        <div class="overflow-hidden max-h-screen absolute left-0 w-full h-full -z-10 hidden lg:block">
            <img ref="container" :class="[isProgress ? 'zoom-in' : 'zoom-out']" alt=""
                class="absolute inset-0 h-full w-full object-cover hidden lg:block -z-10" :src="bgImg" />
        </div>

        <div v-if="showWaltidLoadingSpinner" :class="[isProgress ? 'animate-spin' : '']"
