...
const { currentWallet, dids, selectedDid, pendingDids, acceptCredential, failed, failMessage, credentialCount, groupedCredentialTypes, issuerHost } = await useIssuance(query);
