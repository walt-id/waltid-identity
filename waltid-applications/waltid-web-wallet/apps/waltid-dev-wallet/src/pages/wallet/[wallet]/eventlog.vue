    ...
    <CenterMain>
        ...
        <div class="flex items-center justify-between gap-x-6 py-4">
            <div class="flex flex-none items-center gap-x-4">
                <button v-if="eventLog?.currentStartingAfter" @click="topPage('-1')"
                    class="hidden rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">Top
                </button>
            </div>
            <div class="flex flex-none items-center gap-x-4">
                <button v-if="eventLog?.nextStartingAfter" @click="nextPage(eventLog.nextStartingAfter)"
                    class="hidden rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:block">Next
                </button>
            </div>
        </div>
