<template>
    <div class="min-h-full">
        ...
        <div class="flex w-full h-[calc(100%-5rem)]">
            ...
            <div class="hidden sm:flex w-50 h-full flex-col border-r border-gray-200 bg-white">
                <!-- Sidebar component, swap this element with another sidebar if you like -->
                <div class="flex flex-grow flex-col overflow-y-auto pb-4 pt-5" style="color: rgb(37, 99, 235)">
            ...
            <main class="px-5 sm:px-0 pb-8 w-full">
                <slot />
            </main>
        </div>
    </div>
...
const navigation = [
    {
        ...
        items: [
            ...
            { name: "Issuers", href: `/wallet/${currentWallet.value}/settings/issuers`, icon: RectangleStackIcon },
        ],
    },
];
</script>
