...
data class WalletDemoUiState(
    ...
    val interaction: WalletInteractionState = WalletInteractionState.Idle,
    val pendingIncomingRequest: WalletIncomingRequest? = null,
    val replacementRequest: WalletIncomingRequest? = null,
