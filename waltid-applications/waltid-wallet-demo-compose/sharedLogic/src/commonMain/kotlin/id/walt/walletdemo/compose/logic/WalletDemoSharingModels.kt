 ...
 *
 * A protocol without reader authentication is a null reader trust rather than a state here, so no
 * section is rendered at all: showing a reassuring or alarming reader row for an OpenID4VP Digital
 * Credentials request would be a statement about something the request does not contain.
 */
