    ...
    Column(
        ...
        Column(
            ...
            if (page == SettingsPage.Main) {
                for (destination in listOfNotNull(SettingsPage.Protection.takeIf { state.pinLockEnabled }, SettingsPage.Technical)) {
            ...
            if (page == SettingsPage.Protection && state.pinLockEnabled) {
            ...
            if (page == SettingsPage.Main) {
                ...
                onSignOut?.let { signOut ->
                    OutlinedButton(onClick = signOut, modifier = Modifier.fillMaxWidth().testTag(WalletUiTestTags.SettingsSignOut)) { Text("Sign out") }
                }
                Button(
