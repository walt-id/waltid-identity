...
internal object WalletUiTestTags {
    ...
    fun claimQrCode(path: String): String = dynamicTag("claimQrCode", path)
    fun claimQrCodeViewer(path: String): String = dynamicTag("claimQrCodeViewer", path)
    fun claimQrCodeViewerClose(path: String): String = dynamicTag("claimQrCodeViewerClose", path)
