...
internal object WalletUiTestTags {
    ...
    val CredentialCopyRawData = tag("credentialCopyRawData")
    val CredentialDelete = tag("credentialDelete")
    val CredentialDeleteConfirm = tag("credentialDeleteConfirm")
    val Did = tag("did")
    val KeyId = tag("keyId")
    val SettingsAction = tag("settingsAction")
    val SettingsScreen = tag("settingsScreen")
    val SettingsBack = tag("settingsBack")
    val LockAction = tag("lockAction")
    val ResetAction = tag("resetAction")
    val ResetConfirm = tag("resetConfirm")
    val ResetConfirmation = tag("resetConfirmation")
    val ResetCancel = tag("resetCancel")
    val ScanAction = tag("scanAction")
    val ScanEmptyAction = tag("scanEmptyAction")
    val ScanSheet = tag("scanSheet")
    ...
    val ReviewTechnicalDetailsPage = tag("reviewTechnicalDetailsPage")
    val ReviewTechnicalDetailsBack = tag("reviewTechnicalDetailsBack")
    ...
    fun reviewIsland(id: String): String = dynamicTag("reviewIsland", id)
    fun reviewIslandToggle(id: String): String = dynamicTag("reviewIslandToggle", id)
    fun reviewIslandTechnicalDetails(id: String): String = dynamicTag("reviewIslandTechnicalDetails", id)
